...
console.log("Here's the Part 1 results");
for (var i = 0; i < ages.length; i++) {
    console.log("Element " + i + ": " + ages[i]);
};
...
var younger = []
console.log("Here's the Part 2 results");
for (var i = 0; i < ages.length; i++) {
    if (ages[i] <= 20) {
        younger.push(ages[i]);
        console.log("Element " + i + ": " + ages[i] + " added to 'younger' array");
    }
};
...
console.log("Here's the Part 3 results");
for (var i = younger.length - 1; i >= 0; i--) {
    console.log("younger element " + i + ": " + younger[i]);
};
...
*/
// Part 1:
console.log("Here's the Part 4-1 results");
var i = 0;
while (i < ages.length) {
    console.log("Element " + i + ": " + ages[i]);
    i++;
...
// Part 2:
var younger = []
console.log("Here's the Part 4-2 results");
var i = 0;
while (i < ages.length) {
    if (ages[i] <= 20) {
        younger.push(ages[i]);
...
// Part 3:
console.log("Here's the Part 4-3 results");
